...
def main():
    ...
    information = f"""
        Elon Reeve Musk, born June 28, 1971) is a businessman and public official known for his leadership of Tesla and SpaceX. Musk has been the wealthiest person in the world since 2025; as of May 2026, Forbes estimates his net worth to be US$788 billion.
    ...
    summary_template = f"""
        ...
        1. A summary of the person's life
        2. 2 interesting facts about the person.pow
        """

    summary_prompt_template = PromptTemplate(template=summary_template, input_variables=["information"])
    
    llm = ChatGroq(api_key=os.getenv("GROQ_API_KEY"),model="llama-3.3-70b-versatile",temperature=0.0)
